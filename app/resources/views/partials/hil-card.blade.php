<div class="side-menu-container">
    ...
    <a href="/linkage/hil-dashboard"><i class="fas fa-home"></i> <em class="unhidden">Dashboard</em></a>
    ...
    <div class="ajax-lg-bx mt-10 p-10">
        <a href="/linkage/view-feedbacks"><i class="fas fa-chevron-right"></i>
 ...
 <a href="/view-college-programmes"><i class="fas fa-eye"></i> <em class="unhidden3">College Programmes</em></a>-->
    ...
    <div class="ajax-depart-lx-bx mt-10 p-10">
        <a href="/linkage/generate-report"><i class="fas fa-chevron-right"></i> <em class="unhidden5">Generate Report</em></a>
    </div>
 ...
 <em class="unhidden8">Vaccancy Management</em> <i class="fas fa-angle-down"></i>
    ...
    <div class="ajax-course-mgt mt-10 p-10">
        <a href="/linkage/field-vaccancy"><i class="fas fa-chevron-right"></i> <em class="unhidden9">Field Vaccancy</em></a>
        <a href="/linkage/view-vaccancy"><i class="fas fa-chevron-right"></i> <em class="unhidden15">View Vaccanies</em></a>
    </div>
    ...
    <div class="ajax-student-container">
        <a href="/linkage/assigned-supervisors"><i class="fas fa-chevron-right"></i> <em class="unhidden11">Assigned Supervisors</em></a>
    </div>
