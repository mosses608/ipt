<div class="side-menu-container">
    <br><br><br><br>
    <a href="/trainers/trainer-dashboard"><i class="fas fa-home"></i> Dashboard</a>
    ...
    <div class="ajax-lg-bx mt-10 p-10">
        <a href="/trainers/attendance"><i class="fas fa-check"></i>
 Student Attendance</a>
 <a href="/trainers/activities"><i class="fas fa-eye"></i> Student Activities</a>
 <a href="/trainers/performance"><i class="fas fa-eye"></i> Assessment & Evaluation</a>
    </div>


    <a href="#" onclick="showhiddenregdep()"><i class="fas fa-calendar-check"></i> Scheduling <i class="fas fa-angle-down"></i>
</a></a>
    <div class="ajax-depart-lx-bx mt-10 p-10">
        <a href="/trainers/task-plans"><i class="fas fa-chevron-right"></i> Activity Plan</a>
    </div>


    <a href="#" onclick="showhiddenregcour()"><i class="fas fa-tasks"></i>
 Report Management <i class="fas fa-angle-down"></i>
</a></a>
    <div class="ajax-course-mgt mt-10 p-10">
        <a href="/trainers/report"><i class="fas fa-chevron-right"></i> Generate Report</a>
    </div>
