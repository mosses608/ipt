<div class="side-menu-container">
    ...
    <a href="/principal/principal-dashboard"><i class="fas fa-home"></i> <em class="unhidden">Dashboard</em></a>

    <a href="#" onclick="showhiddenregcoll()"><i class="fas fa-graduation-cap"></i> <em class="unhidden0">Student Management</em> <i class="fas fa-angle-down"></i>
</a>
    <div class="ajax-lg-bx mt-10 p-10">
        <a href="/principal/view-students"><i class="fas fa-chevron-right"></i>
 <em class="unhidden1">View Students</em></a>
 <!--<a href="#"><i class="fas fa-chevron-right"></i> <em class="unhidden2">College Principal</em></a>
 <a href="#"><i class="fas fa-eye"></i> <em class="unhidden3">College Programmes</em></a>-->
    </div>


    <a href="#" onclick="showhiddenregdep()"><i class="fas fa-user-tie"></i> <em class="unhidden4">Staffs Management</em> <i class="fas fa-angle-down"></i>
</a></a>
    <div class="ajax-depart-lx-bx mt-10 p-10">
       <!-- <a href="#"><i class="fas fa-chevron-right"></i> <em class="unhidden5">Register department</em></a>
        <a href="/register-staff"><i class="fas fa-chevron-right"></i> <em class="unhidden6">Department Staff</em></a>-->
        <a href="/principal/view-staff"><i class="fas fa-chevron-right"></i> <i class="fa fa-eye"></i> <em class="unhidden7">View Staff</em></a>
    </div>


    <a href="#" onclick="showhiddenregcour()"><i class="fas fa-book"></i>
 <em class="unhidden8">Report Management</em> <i class="fas fa-angle-down"></i>
</a></a>
    <div class="ajax-course-mgt mt-10 p-10">
        <a href="/principal/report"><i class="fas fa-chevron-right"></i> <em class="unhidden9">Generate Report</em></a>
    </div>
...
-->
    ...
    <a href="#" onclick="showhiddenregstaff()"><i class="fas fa-comment"></i>
 <em class="unhidden13">Feedback Management</em> <i class="fas fa-angle-down"></i>
</a></a>
 <div class="uni-staff-container-holder">
    ...
    <a href="/principal/view-feedbacks"><i class="fas fa-chevron-right"></i> <em class="unhidden15">View Feedbacks</em></a>
 </div>
