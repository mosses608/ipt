...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <header>
            ...
            <p class="admin-profile-cont" style=" float: right; cursor:pointer;"  onclick="showAdminData()"><img src="{{auth()->guard('hod')->user()->profile ? asset('storage/' . auth()->guard('hod')->user()->profile) : asset('images/profile.png')}}" alt=""> <span style="float: right;">{{auth()->guard('hod')->user()->full_name}} <i class="fas fa-angle-down"></i></span> </p><br>
        </header>
        ...
        <div class="hidden-admin-file">
                <form action="/signout" method="POST" class="sign-out">
                    ...
                    <a href="#"><i class="fas fa-user-shield"></i> Department Staff</a><hr><hr>
