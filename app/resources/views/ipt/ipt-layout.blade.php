...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <header>
            ...
            <p class="admin-profile-cont" style=" float: right; cursor:pointer;"  onclick="showAdminData()"><span style="float: right;">{{auth()->guard('coordinator')->user()->full_name}} <i class="fas fa-angle-down"></i></span> </p><br>
        </header>
        ...
        <div class="hidden-admin-file">
                <form action="/signout" method="POST" class="sign-out">
                    ...
                    <a href="/coordinator-profile"><i class="fa fa-user"></i> My Profile</a>
