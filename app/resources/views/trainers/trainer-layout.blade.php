...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>IPT | Student | Dashboard</title>
...
<br>
        <div class="message-child-content-holder">
            ...
            <div class="sub-component-container">
                <div class="profile-layout">
                    <img src="{{$message->profile ? asset('storage/' . $message->profile) : asset('images/profile.png')}}" alt="My Profile">
        ...
        <form action="/messages" method="POST" class="message-sender-class">
            @csrf
            <input type="hidden" name="profile" id="" value="{{auth()->guard('trainer')->user()->profile}}">
            <input type="hidden" name="sender_name" id="" value="{{auth()->guard('trainer')->user()->full_name}}">
